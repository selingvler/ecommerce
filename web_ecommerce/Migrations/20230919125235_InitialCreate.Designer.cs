...
namespace web_ecommerce.Migrations
{
    ...
    [Migration("20230919125235_InitialCreate")]
            ...
            modelBuilder.Entity("web_ecommerce.Entities.OrderInstance", b =>
                {
                    b.HasOne("web_ecommerce.Entities.Order", "Order")
                        .WithOne("OrderInstance")
                        .HasForeignKey("web_ecommerce.Entities.OrderInstance", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("web_ecommerce.Entities.UserProduct", "UserProduct")
                        .WithOne("OrderInstance")
                        .HasForeignKey("web_ecommerce.Entities.OrderInstance", "UserProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
